...
現在は \*\*Day 12：pandasの開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10、Day 11は完了済み。
...
Day 12では、pandasを使って表形式のデータを扱う方法を学ぶ。
...
pandasでCSVファイルを読み込む小さい例を1つだけ見せる。
...
似た問題として、ETF価格データをpandasで読み込み、ETF名と価格を確認する処理を私に書かせる。
