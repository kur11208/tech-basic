...
現在は \*\*Day 29：Web画面統合の開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10、Day 11、Day 12、Day 13、Day 14、Day 15、Day 16、Day 17、Day 18、Day 19、Day 20、Day 21、Day 22、Day 23、Day 24、Day 25、Day 26、Day 27、Day 28は完了済み。
...
Day 29では、これまで作成したETFデータ・売買シグナル・損益計算をWeb画面に表示する。
...
これまでの学習内容を組み合わせ、ETF管理アプリの情報を1画面にまとめて表示する。
