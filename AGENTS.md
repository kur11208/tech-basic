...
\- range(1, 6) は何を表示するときに使ったか

\- while はどんなときに繰り返すか

\- while で値を増やし忘れるとどうなるか
...
似た問題として、ETF名を3つリストに入れて、1つずつ表示するコードを私に書かせる。
