...
現在は \*\*Day 14：GET / POSTの開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10、Day 11、Day 12、Day 13は完了済み。
...
Day 14では、FastAPIでGETとPOSTの違いを学ぶ。
...
GETで文字を返す処理と、POSTで入力を受け取る処理の違いを確認する。
...
\- FastAPIは何をするために使うものか

\- `@app.get("/")` は何を表すか

\- `uvicorn day13:app --reload` は何をするコマンドか

\- 存在しないURLにアクセスするとどうなるか
