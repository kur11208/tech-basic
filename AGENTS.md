...
現在は \*\*Day 11：datetimeの開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10は完了済み。
...
datetimeで今日の日付を表示する小さい例を1つだけ見せる。
...
似た問題として、現在の日付と時刻を取得し、ETF取引記録の日付として表示する処理を私に書かせる。
