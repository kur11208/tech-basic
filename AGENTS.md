...
現在は \*\*Day 13：FastAPI入門の開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10、Day 11、Day 12は完了済み。
...
Day 13では、FastAPIを使ってWebアプリの入り口を作る方法を学ぶ。
...
FastAPIで小さいWebアプリを起動し、ブラウザに文字を表示する。
...
似た問題として、ETF管理アプリの入り口になる小さい画面を私に書かせる。
