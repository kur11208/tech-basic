...
現在は \*\*Day 24：GitHub公開の開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10、Day 11、Day 12、Day 13、Day 14、Day 15、Day 16、Day 17、Day 18、Day 19、Day 20、Day 21、Day 22、Day 23は完了済み。
...
Day 24では、GitHubに学習用リポジトリを公開する流れを整理する。
...
これまでの学習ファイルを使い、GitHubへ公開する前にローカルの状態を確認する。
