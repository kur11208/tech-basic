...
Day 0、Day 1、Day 2、Day 3、Day 4、Day 5は完了済み。
...
似た問題として、ETF名と価格を受け取って表示する関数を私に書かせる。
