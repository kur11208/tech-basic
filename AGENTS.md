...
現在は \*\*Day 22：FastAPIのテストの開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10、Day 11、Day 12、Day 13、Day 14、Day 15、Day 16、Day 17、Day 18、Day 19、Day 20、Day 21は完了済み。
...
次は \*\*Day 22：FastAPIのテスト\*\*。



Day 22では、pytestを使ってFastAPIの動作を確認する方法を学ぶ。
...
小さいFastAPIアプリを使い、pytestで期待どおりのレスポンスになるか確認する。
