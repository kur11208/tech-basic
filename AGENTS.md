...
現在は \*\*Day 21：pytest入門の開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10、Day 11、Day 12、Day 13、Day 14、Day 15、Day 16、Day 17、Day 18、Day 19、Day 20は完了済み。
...
Day 21では、pytestを使ってPythonコードの動作を確認する方法を学ぶ。
...
小さい関数を作り、pytestで期待どおりの結果になるか確認する。
