...
現在は \*\*Day 19：UPDATE / DELETEの開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10、Day 11、Day 12、Day 13、Day 14、Day 15、Day 16、Day 17、Day 18は完了済み。
...
次は \*\*Day 19：UPDATE / DELETE\*\*。



Day 19では、SQLiteで保存済みデータを変更する方法と削除する方法を学ぶ。
...
SQLiteのテーブルに保存したETF名を変更し、不要なETF名を削除する準備をする。
