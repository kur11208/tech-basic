...
現在は \*\*Day 10：JSON読み書きの開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9は完了済み。
...
Day 10では、PythonでJSONファイルにdictのようなデータを書き込む方法と、JSONファイルの内容を読み込む方法を学ぶ。
...
ETF名と価格をJSONファイルに書き込み、あとから読み込んで表示する。
...
似た問題として、ETF名と価格をJSONファイルに書き込み、読み込んで表示する処理を私に書かせる。
