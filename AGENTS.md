...
現在は \*\*Day 26：ETFデータ読み込みの開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10、Day 11、Day 12、Day 13、Day 14、Day 15、Day 16、Day 17、Day 18、Day 19、Day 20、Day 21、Day 22、Day 23、Day 24、Day 25は完了済み。
...
次は \*\*Day 26：ETFデータ読み込み\*\*。



Day 26では、ETFデータを読み込み、アプリで使うデータの形を確認する。
...
これまでのCSVとpandasの学習内容を使い、ETFデータを読み込む。
...
PythonからSQLiteにSQLを実行して、1件だけデータを変更または削除する。
