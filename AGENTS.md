...
Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10、Day 11、Day 12、Day 13、Day 14、Day 15、Day 16、Day 17、Day 18、Day 19、Day 20、Day 21、Day 22、Day 23、Day 24、Day 25、Day 26、Day 27は完了済み。
...
Day 28では、購入価格、現在価格、口数を使って、損益を計算する。
...
これまでの関数と四則演算の学習内容を使い、購入価格・現在価格・口数から損益を返す。
