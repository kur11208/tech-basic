...
現在は \*\*Day 18：SELECT / INSERTの開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10、Day 11、Day 12、Day 13、Day 14、Day 15、Day 16、Day 17は完了済み。
...
次は \*\*Day 18：SELECT / INSERT\*\*。



Day 18では、SQLiteでデータを入れる方法と取り出す方法を学ぶ。
...
SQLiteのテーブルにETF名を追加し、追加したETF名を取り出す準備をする。
...
\- sqlite3.connect("etf_app.db") は何をするか

\- connection.close() は何をするか

\- データベースファイルを作ることと、SQLでデータを操作することの違いは何か
...
PythonからSQLiteにSQLを実行して、1件だけデータを入れて取り出す。
...
似た問題として、ETF管理アプリ用のデータを1件追加して取り出す処理を私に書かせる。
