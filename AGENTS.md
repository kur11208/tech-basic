...
現在は \*\*Day 20：FastAPI + SQLiteの開始\*\*。



Day 0、Day 1、Day 2、Day 3、Day 4、Day 5、Day 6、Day 7、Day 8、Day 9、Day 10、Day 11、Day 12、Day 13、Day 14、Day 15、Day 16、Day 17、Day 18、Day 19は完了済み。
...
次は \*\*Day 20：FastAPI + SQLite\*\*。



Day 20では、FastAPIからSQLiteのデータを読み込んで表示する方法を学ぶ。
...
\- FastAPIとSQLiteを組み合わせる方法

\- Web画面からDBのデータを表示する方法

\- Pythonコードの中でDB接続と画面表示をつなげる方法

\- ETF管理アプリの画面に保存済みETFを表示する流れ
...
FastAPIの画面で、SQLiteに保存されているETF名を表示する準備をする。
